...
T:CreateToggle({Title = "Aura Tala", Default = false, Callback = function(S)
_G.C = S
task.spawn(function()
while _G.C do
...
T:CreateToggle({Title = "Brillo Full", Default = false, Callback = function(s)
game.Lighting.Brightness = s and 2 or 1
game.Lighting.GlobalShadows = not s
game.Lighting.ClockTime = s and 14 or 0
end})
for i = 1, 75 do print("Nexus World Module Environment Row " .. i) end
end